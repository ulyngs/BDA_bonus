...
I don't have experience with this myself, but it seems the best place to start is Apache Spark, for which there is an R package called `sparklyr` that allows you to work with the tools within R that you're already familiar with.

Watch this RStudio webinar to get started: [Sparklyr: Using Spark with RMarkdown | RStudio Webinar - 2016](https://www.youtube.com/watch?v=GtVwHNxXVgQ)
